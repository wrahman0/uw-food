...
public class UWHoursAndLocation {
	...
	public UWHoursAndLocation(boolean flag){
	...
	public void setOutletElementArrayList(ArrayList<Element> outletElementArrayList){
		this.outletElementArrayList= outletElementArrayList;
	}
	
	public ArrayList<Element> getOutletElementArrayList(){
	...
	public void setOutletObjectArrayList(ArrayList<Outlet> outletObjectArrayList) {
